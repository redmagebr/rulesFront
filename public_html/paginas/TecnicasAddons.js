    ...
    },  
 {
    ...
    },  
	 {
        ...
        description : [
			...
			"Counter Counter I: MP necessário aumentado para 3.",
			...
			"First Strike agora tem o gasto de 1 MP.",
			"High Risk High Reward agora tem o gasto de 2 MP.",
			"Incontrollable Power I, II e III tiveram a redução de custo de MP mexidos para 2,3 e 5 respectivamente (old: 3, 5 e 8).",
			"Leadership - Inspire Bravery: Custo de MP se torna 2 e passa a requerir nível 2.",
			"Leadership - Now you do it: clarificado o texto que agora diz que o usuário também joga o teste de ATK.",
			"Leadership - On My Command: Custo de MP se torna 2.",
			...
			"Smoke and Mirrors: Custo de MP se torna 3 (old: 6).",
			"Soul Strike teve o trecho de custo extra removido, não era para estar lá em primeiro lugar.",
			"Special Attack I: Custo da técnica se torna 2 MP (old: 1), situacional dele poder ser usado sem ocupar slot aumenta seu custo pra 3 MP.",
			"Special Attack II: Custo da técnica se torna 4 MP (old: 2) e passa a requerir nível 2.",
			"Special Attack III: Custo da técnica se torna 4 MP (old: 2) e passa a requerir nível 3",
			"Special Attack Ranged I: Custo da técnica se torna 2 MP (old: 1). Special Attack ranged I agora pode ser adicionado sem gastar slot, mas tendo seu custo aumentado para 3 MP.",
			"Special Attack Ranged II: Custo da técnica passa a ser 4 MP (old: 3) e passa a requerir nível 2",
			"Special Attack Ranged III: Custo da técnica se torna 4 MP (old: 3) e passa a requerir nível 3",
			"Spirit Bomb: Addon removido até ser trabalhado melhor",
			"Strong But Slow I: Custo de MP se torna 1 (old: 0)",
			"Strong But Slow II: Custo de MP se torna 2 (old: 1)",
			"Think Fast: Custo de MP se torna 3 MP (old: 1)",
			...
			"--------------------------------------------",
			"Backstabber: Custo de MP se torna 2 (old: 4)",
			...
			"Hide: Custo de MP se torna 2 (old: 4)",
			...
			"Mirror Image: Custo de MP se torna 4 MP (old: 10)",
...
window.techConceitos = [
    ...
    },
	{
        ...
        descricao : [
            ...
            "Superioridade faz com que o personagem role o dado do teste em questão duas vezes e pegue o melhor resultado como válido.",
...
[
{
    ...
    },
	{
        ...
        "efeitos": [
            "O ataque com esse addon recebe um bônus de acerto igual à +1. Esse addon sofre de unicidade com outros special attack e só pode ser usada por personagens que tenham um atributo de dano.",
            "Aumente o custo da técnica em 2 MP."
        ],
        "conceitos": [
            "unicidade"
    ...
    },
    {
		...
		{
        "tipo": "ataque",
        "nome": "Special Attack Ranged - Basic Master",
        "nomeLimpo": "Special Attack Ranged - Basic Master",
        "efeitos": [
            "O ataque com esse addon recebe um bônus de acerto igual à +1 e um valor de prioridade igual à +1. Esse addon sofre de unicidade com outros special attack e só pode ser usada por personagens que tenham um atributo de dano.",
            "Aumente o custo da técnica em 2 MP."
        ],
        "conceitos": [
            "unicidade"
    ...
    },
    {
        ...
        "efeitos": [
            ...
            "Aumenta o custo da técnica em 3."
        ],
        "conceitos": [
    ...
    },
    {
        ...
        "efeitos": [
            ...
            "Você pode gastar 4 MP para receber um +2 Bônus de Poder em um teste dessas perícias."
        ],
        "conceitos": [
            "stacking",
            "unicidade"
    ...
    },
    {
        ...
        "efeitos": [
            ...
            "Aumente o custo da técnica em 4 MP."
        ],
        "conceitos": [
        ...
        "efeitos": [
            ...
            "Esse addon gasta o turno do usuário quando usado.",
            "Aumente o custo da técnica em 5 MP.",
        ],
        "conceitos": [
        ],
        "nivel": 3
	 ...
	 "superioridade",
        ...
        "efeitos": [
			...
			"Custo: 3 MP base +2 para cada alvo invisível, gasta o turno."
        ],
        "conceitos": [
	 "unicidade",
        ],
	 ...
	 "unicidade",
        ...
        "efeitos": [
            "O personagem pode usar esse addon para causar 2 pontos de dano direto no próprio HP e ganhar um bônus não-nomeado de +1 de dano para cada debuff (condição negativa) ativa sobre ele.",
			...
			"Custo: 1 MP, não gasta o turno mas só pode acontecer 1x por rodada."
        ],
        "conceitos": [
	 "unicidade",
        ],
        ...
        "efeitos": [
			...
			"Custo de MP: 4, consome o turno e somente 1 vez por combate OU 6 MP, consome o turno, somente 1 vez por combate e pode ser usado num aliado."
        ],
        "conceitos": [
	 "unicidade",
        ],
    ...
    },
    {
        ...
        "efeitos": [
            ...
            "Aumente o custo da técnica em 2 MP. Essa habilidade só pode ser usada uma vez por turno do usuário."
        ],
        "conceitos": [
            "marcas",
            "basicos",
    ...
    },
	 {
        ...
        "efeitos": [
			...
			"Gasto de MP igual à 4 e gaste o turno."
        ],
        "conceitos": [
        ],
        "nivel": 2
    ...
    },
    {
        ...
        "nomeLimpo": "Aura",
        "efeitos": [
            "Escolha +2 Dano, +2 RD, +1 Defesa ou +1 Ataque durante a criação dessa técnica. Todos os seus aliados recebem o que foi escolhido como um Bônus de Poder enquanto essa técnica estiver ativa.",
            "Um personagem só pode receber um único bônus de aura, com a aura mais antiga recebendo prioridade sempre, não sendo possível cobrir todos os atributos.",
            "Aumenta o custo por rodada da técnica passiva em 4 MP. O personagem usuário não recebe esses bônus",
        ],
        "conceitos": [
            "unicidade",
			"stacking"
    ...
    },
{
    ...
    },
    {
        ...
        "efeitos": [
            "Enquanto está passiva estiver ligada, você pode decidir gastar um ponto de stamina para recuperar seu MP em 10 pontos.",
			"Para utilizar esse efeito sua sabedoria de combate deve ser menor que seu nível atual.",
        ...
        "efeitos": [
            "O alvo sobre esse efeito pode gastar 2 MP imediatos no momento em que fosse receber um dano e então reduzí-lo em 1 ponto (depois de passar pelas RDs).",
			"A redução não pode transformar o dano à zero (0).",
            "Aumente o custo total da técnica em 1, se for o único addon na técnica, o custo de MP não é aplicado."
        ],
        "conceitos": [
            "unicidade"
        ],
        ...
        "efeitos": [
            "Enquanto a passiva estiver ativa, reduza qualquer custo de MP que você fosse vir a ter em 1, uma vez.",
